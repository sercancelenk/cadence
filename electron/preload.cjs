...
const api = {
  ...
  noteHistoryAppend: (payload) => ipcRenderer.invoke('noteHistory:append', payload),
  noteHistoryPurge: (payload) => ipcRenderer.invoke('noteHistory:purge', payload),
  ...
  backupMirrorGet: () => ipcRenderer.invoke('backupMirror:get'),
  backupMirrorChooseDir: () => ipcRenderer.invoke('backupMirror:chooseDir'),
  backupMirrorClearDir: () => ipcRenderer.invoke('backupMirror:clearDir'),
  backupMirrorRunNow: (data) => ipcRenderer.invoke('backupMirror:runNow', { data }),
